    ...
    <div class="g-0">
        <div id="content" class="c-3-5">
			...
			<div class="mod-main">
                        <div class="mt">
                            <ul class="extra-l">
                                <li class="fore-1"><a class="curr">基本信息</a></li>
                            ...
                            <div class="user-set userset-lcol">
                                <div class="form">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" name="userVo.realName" id="realName" value="张三">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt itxt1" name="userVo.address" id="address" value="北京市昌平区建材城西路金燕龙办公楼一层">
